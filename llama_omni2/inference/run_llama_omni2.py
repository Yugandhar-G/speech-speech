...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature", type=float, default=0.7, help="Temperature for sampling (0.0=greedy, 0.7=balanced, 1.0=creative). Use 0.7 for detailed answers.")
    parser.add_argument("--top_p", type=float, default=0.9, help="Nucleus sampling threshold (0.0-1.0). Use 0.9 for detailed answers.")
    parser.add_argument("--top_k", type=int, default=None, help="Top-k sampling (optional)")
    parser.add_argument("--num_beams", type=int, default=1, help="Beam search width (1=no beam search)")
    parser.add_argument("--max_new_tokens", type=int, default=512, help="Maximum tokens to generate. Use 512+ for detailed answers.")
